  ...
  return (
    <>
      ...
      <main className="flex flex-col md:flex-col  lg:flex-row w-screen h-auto overflow-hidden">
        ...
        <section className="mt-4 sm:mt-[50px] lg:mr-12  lg:w-[45%] w-full">
          {/* top row modified */}
          <div className="flex flex-col  max-w-full md:max-w-[400px] sm:h-[500px] h-[400px] mb-5 bg-[#EFEFF0] sm:ml-[30px] lg:ml-[20px] shadow-lg sm:mr-[20px] lg:mr-[20px] items-center font-mono rounded-lg">
            <p className="sm:mt-[30px] mt-[30px] text-[14px] sm:text-[16px] font-[500px] text-[#000000] tracking-tighter">
